...
# Paths
data_dir = 'src'
csv_file_path = os.path.join(data_dir, 'data/Testing_15per.csv')
images_dir = os.path.join(data_dir, 'data/data_right/images')
labels_dir = os.path.join(data_dir, 'data/data_right/labels')
...
for index, row in df.iterrows():
    image_name_no_ext = row['imageRight']
    points_str = row['Right_2D']
