...
test_csv_files = ['data/Test_CSVs/Trajectory_8.csv']

#image_folders_left = ['src/data/TestData/Trajectory_8/Left_Images']
image_folders_right = ['src/data/TestData/Trajectory_8/Right_Images']
'''

train_csv_files = ['data/CSVs/Training_Sample.csv']
eval_csv_files = ['data/CSVs/Validation_Sample.csv']
test_csv_files = ['src/data/Video/Left1.csv']

image_folders_left = ['src/data/Video/Left1']
image_folders_right = ['src/data/Video/Right1']


"""
train_csv_files = ['data/CSVs/Training_Sample.csv']
eval_csv_files = ['data/CSVs/Validation_Sample.csv']
test_csv_files = ['data/CSVs/Testing_5per.csv']
