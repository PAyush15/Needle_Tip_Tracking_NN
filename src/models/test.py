...
from prep_dataset_test import test_loader
...
def main():
    ...
    model.load_state_dict(torch.load("Saved_Models/cross_valid_model.pt"))
    model.eval()
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        test_loss, avg_dist, mae, mae_std = test(model, device, test_loader)
