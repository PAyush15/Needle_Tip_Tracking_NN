...
test_csv_files = ['data/Test_CSVs/Trajectory_6.csv']

image_folders_left = ['src/data/TestData/Trajectory_6/Left_Images']
image_folders_right = ['src/data/TestData/Trajectory_6/Right_Images']
